...
var requiredOpts = {
  infoHash: Buffer.from([
    135, 194, 8, 189, 60, 197, 84, 15, 123, 79, 244, 146, 151, 167, 55, 50, 223,
    216, 219, 186,
  ]), // hex string or Buffer
  peerId: Buffer.from("01234567890123456789"), // hex string or Buffer
  announce: ["http://127.0.0.1:9000/announce"], // list of tracker server urls
